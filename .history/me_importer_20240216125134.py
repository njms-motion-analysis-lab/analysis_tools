...
if __name__ == '__main__':
    ...
    def convert_csv_and_preserve_headers(csv_file):
        try:
            ...
            # If parsing error occurs, try skipping bad lines
            print(f"ParserError encountered in {csv_file}. Trying to skip problematic lines.")
            df = pd.read_csv(csv_file, encoding='ISO-8859-1', error_bad_lines=False, warn_bad_lines=True)
