...
FEATURE_CATEGORY_PATTERNS = {
    ...
    'trend_based': ['agg_linear_trend', 'linear_trend', 'time_reversal_asymmetry_statistic', 'friedrich_coefficients'],
    'frequency_based': ['fft_aggregated', 'fft_coefficient', 'freq', 'spkt_welch_density'],
    'wavelet_based': ['cwt_coefficients', 'wavelet'],
    'complexity_measures': ['approximate_entropy'],
    'nonlinearity_measures': ['c3']  # New category for nonlinearity measures
    'stationarity_tests': ['augmented_dickey_fuller'],
