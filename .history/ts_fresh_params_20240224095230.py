...
feature_categories_patterns = {
    'energy_based': ['abs_energy', 'absolute_sum_of_changes'],
    'statistical': ['absolute_maximum', 'count_above_mean', 'count_below_mean', 'mean', 'median', 'quantile', 
                    'skewness', 'kurtosis', 'standard_deviation', 'variance', 'sum_values'],
    'autocorrelation': ['agg_autocorrelation', 'autocorrelation', 'partial_autocorrelation'],
    'trend_based': ['agg_linear_trend', 'linear_trend', 'time_reversal_asymmetry_statistic'],
    'frequency_based': ['fft_aggregated', 'fft_coefficient', 'freq', 'spkt_welch_density'],
    'wavelet_based': ['cwt_coefficients', 'wavelet']
    # Add more categories and patterns as needed
}
def categorize_feature(beeswarm_name):
    """
    ...
    """
    for category, patterns in feature_categories_patterns.items():
        ...
        for pattern in patterns:
            ...
            if re.search(re.escape(pattern), beeswarm_name, re.IGNORECASE):
                return category
    return 'unknown_category'  # Return a default category if no match is found
