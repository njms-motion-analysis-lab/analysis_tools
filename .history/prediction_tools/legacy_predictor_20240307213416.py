...
# Remove this after new data (add_other)
    def get_df(self, force_load=True, add_other=True):
        def gen_df():
            ...
            xy_merged = pd.merge(x, y, on=['cohort', 'is_dominant', 'patient'], how='outer', suffixes=('_x', '_y'))
            final_df_2 = pd.merge(xy_merged, z, on=['cohort', 'is_dominant', 'patient'], how='outer', suffixes=('', '_z'))
