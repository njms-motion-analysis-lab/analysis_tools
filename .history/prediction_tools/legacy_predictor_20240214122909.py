...
class Predictor(LegacyBaseModel):
    ...
    def generate_sub_grad_num(self, sensor=None):
        ...
        for self_pt in self_pts:
            ...
            self_temp, counter_temp = self.get_temp_sub_grads(self_pt, counterpart_pt, sensor, counterpart_sensor, curr_patient, features_dom, features_non_dom)
