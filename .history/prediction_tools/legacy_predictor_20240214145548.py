...
class Predictor(LegacyBaseModel):
    ...
    @classmethod
    def trim_bdf_with_boruta(cls, bdf, y, n_estimators=100, max_depth=5, random_state=42):
        ...
        # Initialize Boruta
        boruta_selector = BorutaPy(rf, n_estimators=n_estimators,random_state=42,verbose=2,max_iter=500,alpha=0.05)
