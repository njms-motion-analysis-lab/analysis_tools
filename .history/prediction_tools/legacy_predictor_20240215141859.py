        ...
        classifiers = {
            ...
            'RandomForest': {
                ...
                'param_grid': {
                    ...
                    'classifier__max_features': ['sqrt', 'log2'] if feature_count > 50 else [None],
                }
            },
            'ExtraTrees': {
                'classifier': ExtraTreesClassifier(),
                'param_grid': {
                    ...
                    'classifier__max_features': ['sqrt', 'log2'] if feature_count > 50 else [],
                }
            },
            'GradientBoosting': {
                'classifier': GradientBoostingClassifier(),
            ...
            'DecisionTree': {
                ...
                'param_grid': {
                    ...
                    'classifier__max_features': ['sqrt', 'log2', None] if feature_count > 50 else None,
                }
            },
            'LogisticRegression': {
                'classifier': LogisticRegression(max_iter=10000, solver='liblinear'),
