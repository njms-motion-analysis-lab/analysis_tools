...
class MultiPredictor(LegacyBaseModel):
    ...
    def plot_shap_changes(self, shap_scores, top_scores, sensors, percentage_of_average=False, first_model_features=None, num_top=NUM_TOP, include_accuracy=True, axis=False):
