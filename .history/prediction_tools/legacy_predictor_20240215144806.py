        ...
        classifiers = {
            ...
            'RandomForest': {
                ...
                'param_grid': {
                    ...
                    'classifier__max_depth': [None, 10, 20, 30] if feature_count > 52 else [None, 2, 4, 6, 8, 10, 16],
            ...
            'ExtraTrees': {
                ...
                'param_grid': {
                    'classifier__n_estimators': [6, 12, 24, 50, 100, 200, 400] if feature_count > 52 else [6, 12, 24, 50],
                    'classifier__max_depth': [None, 20, 40, 60] if feature_count > 52 else [None, 2, 4, 6, 10, 20, 30],
                    'classifier__min_samples_split': [2, 4, 6, 10, 15],
                    'classifier__min_samples_leaf': [1, 2, 4, 6, 10],
                    'classifier__max_features': ['sqrt', 'log2']
                }
        ...
        if use_mini_params:
            ...
            classifiers = {
                ...
                'ExtraTrees': {
                    'classifier': ExtraTreesClassifier(),
                    'param_grid': {
                        'classifier__n_estimators': [6, 12, 24, 50, 100, 200, 400] if feature_count > 52 else [6, 12, 24, 75],
                        'classifier__max_depth': [None, 20, 40, 60] if feature_count > 52 else [None, 2, 4, 6, 10, 20, 30],
                        'classifier__min_samples_split': [2, 4, 6, 10, 15],
                        'classifier__min_samples_leaf': [1, 2, 4, 6, 10],
                        'classifier__max_features': ['sqrt', 'log2']
