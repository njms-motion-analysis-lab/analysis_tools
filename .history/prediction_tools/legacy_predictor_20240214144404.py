...
class Predictor(LegacyBaseModel):
    ...
    def generate_sub_gradient_count(self, sensor=None):
        ...
        name = 'grad_data__mean_sub_gradient_count' + '_' + self.sensor.axis
        df_renamed = df_reset.rename(columns={'index': 'grad_data__patient_id_' + sensor.axis, 0: 'grad_data__mean_sub_gradient_count'})
