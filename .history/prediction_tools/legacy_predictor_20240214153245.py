...
class Predictor(LegacyBaseModel):
    ...
    @classmethod
    def trim_bdf_with_boruta(cls, bdf, y, n_estimators=250, max_depth=5, random_state=42):
        # Assuming 'bdf' is your dataframe without the target variable 'is_dominant'
        # Columns to retain regardless of feature selection
        columns_to_retain = ['is_dominant', 'patient', 'grad_data__mean_sub_gradient_count_0_x', 'grad_data__mean_sub_gradient_count_0_y','grad_data__mean_sub_gradient_count_0_z' ]
        ...
        # Initialize Boruta
        boruta_selector = BorutaPy(rf, n_estimators=n_estimators,random_state=42,verbose=2,max_iter=250,alpha=0.05)
