...
FEATURE_CATEGORY_PATTERNS = {
    ...
    'statistical': [
        ...
        'range_count', 'ratio_beyond_r_sigma', 'sample_entropy', 'variation_coefficient', 'benford_correlation'
    ],
    ...
    'complexity_measures': ['approximate_entropy', 'lempel_ziv_complexity', 'permutation_entropy'],
