...
class MatrixPlotter(LegacyBaseModel):
    ...
    @staticmethod
    def show(results, results_two=None, task=None, h_one=None, h_two=None):
        return MatrixPlotter.view_and_save_results(results, results_two=results_two,task=task, h_one=h_one,h_two=h_two)

    @staticmethod
    def view_and_save_results(results, results_two=None, task=None, h_one=None, h_two=None):
